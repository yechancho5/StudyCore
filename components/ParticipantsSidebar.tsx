...
const ParticipantsSidebar: React.FC<ParticipantsSidebarProps> = ({
  ...
  const hasAnswered = (userId: string) => {
    // Check if this user has an answer using their localStorage userId
    const hasAnswer = answers.some(answer => answer.userId === userId);
    console.log(`User ${userId} has answered: ${hasAnswer}`, {
